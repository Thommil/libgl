...
void main()                                                 	
{
	...
	v_BaseColorVec4 =  (u_MaterialAmbientVec4 * u_LightAmbientColorVec4) + (u_MaterialDiffuseVec4 * u_LightColorVec4 * l_DiffuseFloat * max(l_DotNormalLightFloat, C_ZERO_FLOAT));		
