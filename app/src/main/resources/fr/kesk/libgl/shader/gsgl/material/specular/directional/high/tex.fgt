...
{	
	...
	gl_FragColor = texture2D(u_TextureIndexSampler2D, v_TexCoordinateVec2) * (v_BaseAmbientColorVec4 + (u_LightColorVec4 * max(l_DotNormalLightFloat, C_ZERO_FLOAT))) + l_SpecularBaseColorVec4;
}	