/**
* 	Specular point lighting helper shader in PerVertex 
* 	
...
void main()                                                 	
{
	...
	v_BaseColorVec4 = (u_MaterialAmbientVec4 * u_LightAmbientColorVec4) + (l_DiffuseFloat * ((u_MaterialSpecularVec4 * u_LightColorVec4 * pow(l_SpecularTermFloat, u_MaterialShininessFloat)) + ((u_MaterialDiffuseVec4 * u_LightColorVec4) * max(l_DotNormalLightFloat, C_ZERO_FLOAT))));	
